...
<head>
	...
	<script type="text/javascript" src="../ETCommonmenu/ETstafflist.js"></script>
</head>
<body>
    <div class="container">
        <h1>Hiring of Equipment</h1>
        <form name = "hireform" action="ETaddhire.php" method="POST"  >
            ...
            <input type="submit" value="Submit" name="Submit" onclick="validateHireForm()"  >
