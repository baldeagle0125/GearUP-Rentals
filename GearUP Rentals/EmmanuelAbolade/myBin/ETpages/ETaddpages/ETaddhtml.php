...
<head> 
	...
	<script type="text/javascript" src="../ETCommonmenu/ETsupplierlist.js"></script>
</head>
...
<body>
	...
	<form name="addETform" id="addETform" onsubmit="return validateForm()" method="POST" action="ETadd.php">
        ...
        <label for="ETid">Equipment Type ID: </label> 
            <input type="text" name="ETid" id="ETid" placeholder = "Enter the ID for the Equipment Type" Title="ID is auto generated. Never mind!" pattern ="[0-9]*" autocomplete=off /> 
        ...
        <label for="rentalcostperday">Rental Cost per Day:</label>
		 ...
		 <div>
		 	...
		 	<button onclick="window.location.href = '../ETCommonmenu/ETmenumaintenance.php';">Back To Menu</button><br><br>				
