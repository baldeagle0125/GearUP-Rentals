...
<body>
    <div class="container">
        ...
        <form name = "hireform" action="ETaddhire.php" method="POST" onsubmit="validateForm()"  >
            ...
            <select type="text" name="equipment_type" id="equipment_type" title = "Choose a description" onclick = "selectdescription()" required><br>
            ...
            <input type="number" name="num_days" id="num_days" required><br>
			
			<label for="num_items">Number of Equipment items:</label>
            <input type="number" name="num_items" id="num_items" required><br>

            <!-- Option to make a payment or add to customer's account balance -->
            <label for="payment">Make Payment:</label>
            <input type="checkbox" name="payment" id="payment" required><br>
			
			<!-- submitand reset field -->
			<input type="reset" value="Clear all fields" name="reset" />
            <input type="submit" value="Submit" name="Submit" onclick="validateForm()" required >
