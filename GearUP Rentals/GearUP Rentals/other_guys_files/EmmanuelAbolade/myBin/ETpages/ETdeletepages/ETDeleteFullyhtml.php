...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../ETCommonmenu/menu.css">
    <script>
...
<body class="ETmenu">
	<?php include "../ETCommonmenu/menu.php"; // Includes menu navigation ?> 
	...
	<div class="delcontainer">
	  ...
	  <form name="deleteForm" id="deleteviewform" action="ETDeleteFully.php" onsubmit="return confirmCheck()" method="POST">
		<br>  
		...
		<br><br>
		 ...
		 <div>
		 	...
		 	<button name="back" onclick="window.location.href = '../ETCommonmenu/ETmenumaintenance.php';">Back To Menu</button><br><br>				
...
<?php include "../ETCommonmenu/footer.php"; // Includes footer 
