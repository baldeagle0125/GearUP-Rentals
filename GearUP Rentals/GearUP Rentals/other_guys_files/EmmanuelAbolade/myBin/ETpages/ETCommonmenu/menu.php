...
<body>
	<header>
    <!-- Logo image -->
    <img src="../images/GearUpLogo.png" alt="Gear Up Hire Equipment Logo">
	</header>
	...
	<nav>
		<ul>
			...
			<li><a href="../EThire/hire_equipment.html.php" class="dropbtn">Hiring of Equipment</a></li>
			...
			<li class="dropdown"><a href="#" class="dropbtn">File Maintenance Menu</a>
        		...
        		<div class="dropdown-content">
					...
					<!-- Link to Supplier Maintenance Menu -->
          			<a href="./supplier/supplierHome.html.php">Supplier Maintenance Menu</a>
